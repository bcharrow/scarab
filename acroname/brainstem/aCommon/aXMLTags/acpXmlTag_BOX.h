...
#ifndef _acpXmlTag_BOX_H_
#define _acpXmlTag_BOX_H_

#include "acpPkgXML.h"

#include "acpXmlTag_GEOMETRY.h"
#include "acpXmlTag_COLOR.h"
#include "acpXmlTag_DIMENSIONS.h"
  ...
  public GEOMETRY
{
  ...
  private:
    COLOR*		m_pColor;
    DIMENSIONS*		m_pDimensions;
};

#endif // _acpXmlTag_BOX_H_
