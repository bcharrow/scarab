...
#ifndef _acpGetCounterMessage_H_
#define _acpGetCounterMessage_H_

#include "acpGarciaInternal.h"

class acpGetCounterMessage :
  public acpMessage
{
  public:

  			acpGetCounterMessage(
...
#endif // _acpGetCounterMessage_H_
