...
#ifndef _acpGetOdometerMessage_H_
#define _acpGetOdometerMessage_H_

#include "acpGarciaInternal.h"

class acpGetOdometerMessage :
  public acpMessage
{
  public:

  			acpGetOdometerMessage(
...
#endif // _acpGetOdometerMessage_H_
