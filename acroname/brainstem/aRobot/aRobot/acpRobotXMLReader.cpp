/////////////////////////////////////////////////////////////////////
//                                                                 //
// file: acpRobotXMLReader.cpp                                     //
//                                                                 //
/////////////////////////////////////////////////////////////////////
//                                                                 //
// description: Implementation of the Robot API XML reader object. //
//                                                                 //
/////////////////////////////////////////////////////////////////////
//                                                                 //
...
acpRobotXMLReader::acpRobotXMLReader() :
  acpObject("xml-script"),
  m_pRobotInternal(NULL),
  m_ioRef(NULL),
  m_streamInput(NULL),
  m_streamStatus(NULL),
  m_streamError(NULL),
...
acpRobotXMLReader::acpRobotXMLReader(
  ...
  m_ioRef(m_pRobotInternal->m_ioRef),
  m_streamInput(input),
...
aErr acpRobotXMLReader::errProc(
  tkError error,
...
{
  char buff[80];
  acpRobotXMLReader* pal = (acpRobotXMLReader*)errProcRef;
...
aErr acpRobotXMLReader::sActStart(
  aXMLNodeRef node,
  const char* pKey,
  void* vpRef)
{
  ...
  acpRobotXMLReader* pal = (acpRobotXMLReader*)vpRef;
  aAssert(pal);
      ...
      if (pal->checkHistory(0)) {
        ...
        if (actErr == aErrNone) {
          pal->m_pParseBehavior = 
            pal->m_pRobotInternal->createNamedBehavior(
...
aErr acpRobotXMLReader::sActContent(
  aXMLNodeRef node,
  const char* pKey,
  const aToken* pValue,
  void* vpRef)
...
aErr acpRobotXMLReader::sActEnd(
  aXMLNodeRef node,
  aXMLNodeRef parent,
  const char* pKey,
  void* vpRef)
...
aErr acpRobotXMLReader::sActSeekContent(
  aXMLNodeRef node,
  const char* pKey,
  const aToken* pValue,
  void* vpRef)
...
aErr acpRobotXMLReader::xmlSeek(
  const char* pKey,
  acpValue::eType type,
  aXMLNodeRef node)
{
...
aErr acpRobotXMLReader::xmlImport(
...
void acpRobotXMLReader::runtimeError()
{
...
bool acpRobotXMLReader::checkHistory(int nFlags)
{
